...
![version](https://img.shields.io/badge/version-v2.5.12-4d938a?style=for-the-badge)
...
- **주기 업무(v2.4.0)**: [설정] 메뉴 → 주기 업무 입력·관리에서 공통 내용+반복 주기(매주 요일 / 매월 며칠)만 등록하면, 예정일마다 자식 업무가 보드에 자동 생성되는 **부모-자식** 구조
